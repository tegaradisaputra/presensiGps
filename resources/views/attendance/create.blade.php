...
@push('myscript')
    <script>
        ...
        let radius_notifikasi = document.getElementById('radius_notifikasi')
        Webcam.set({
            height:480,
            width:640,
            image_format:'jpeg',
        ...
        function successCallback(position) {
            ...
            var circle = L.circle([-7.923125627065127, 110.2965900461825], {
                color: 'red',
                fillColor: '#f03',
                fillOpacity: 0.5,
                radius: 35
